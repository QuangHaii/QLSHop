	...
	<div class="main-panel">
		<div class="card">
			<div class="card-body" style="background: white">
				...
				<div class="row">
					<form method="post" action="/QLShop/Product/Edit"
							...
							<div class="form-row">
								...
								<div class="col-3 form-group">
									<input name="productName" class="form-control"
										value="${product.productName }" /> <span class="text-danger"></span>
								</div>
								...
								<div class="form-check col-md-3"text-transform:uppercase;>
									<select class="form-control" name="brand">
										<c:forEach var="item" items="${list }">
											<c:choose>
												<c:when test="${product.brand == item }">
							...
							<div class="form-row">
								...
								<div class="col-3 form-group">
									<input name="price" class="form-control"
										value="${product.price }" /> <span class="text-danger"></span>
								</div>
								<div class="col-2 form-group"></div>
								<div class="col-2 form-group"
									style="align-self: center; text-align: center">
								...
								<div class="col-3 form-group">
									<select class="form-control" name="category">
										<c:forEach var="item" items="${cateList }">
											<c:choose>
												<c:when test="${product.category == item }">
													<option selected>${item}</option>
												</c:when>
												<c:otherwise>
													<option>${item }</option>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-4">
									<div class="btn btn-primary btn-icon-text">
										<i class="fas fa-cloud-upload-alt"></i> <input type="file"
								...
								<div class="col-3 form-group">
									<input name="discount" class="form-control"
										value="${product.discountPercentage }" /> <span
